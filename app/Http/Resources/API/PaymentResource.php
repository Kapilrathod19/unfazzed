...
class PaymentResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'service_id'    => isset($this->booking) ? optional($this->booking)->service_id : null,
            'service_name'  => isset($this->booking) ? optional($this->booking)->service->name : null,
            'service_attchments' => isset($this->booking) ? getAttachments(optional($this->booking)->service->getMedia('service_attachment')) : [],
