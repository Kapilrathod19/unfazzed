...
<body>
    <div style="padding: 24px 0 0;">
        <div style="padding-bottom: 16px; margin-bottom: 16px; border-bottom:  1px solid #ccc;">
            <div style="overflow: hidden;">
                <div style="float: left; display: inline-block;">
                    ...
                    <img style="height: 32px; width: 32px; "
                        src="{{ getSingleMedia(\App\Models\AppSetting::first(), 'site_logo', false) }}">
                    <span
                        style="display: inline-block; line-height: normal; vertical-align: super; padding-left: 12px;">
                        <span style="color: #1C1F34; vertical-align: inherit;">{{ $generaldata->site_name ?? '' }}</span>
                    </span>
                </div>
        ...
        <div class="bottom-section">
            <h4 style="margin-bottom: 8px;">Unfazzed Technologies LLP Terms & Conditions:</h4>
            <p style="margin:8px 0; font-size: 14px; text-align:justify;">Payment once made is non-refundable. Invoice must be cleared within the agreed due date. Delayed payments may attract additional charges. Services/products delivered are subject to agreed project scope only. Any disputes shall be subject to jurisdiction of applicable local courts.
            </p>
        </div>
