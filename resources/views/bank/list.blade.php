                    ...
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            @if ($auth_user->can('service add'))
                                <a href="{{ route('bank.create', ['user_id' => $providerdata->id]) }}"
                                    class=" float-end me-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i>
                                    {{ trans('messages.add_form_title', ['form' => trans('messages.bank')]) }}</a>
                            @endif
                        </div>
            ...
            <div class="card-body">
                <div class="row justify-content-between gy-3">
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="col-md-12">
                            <form action="{{ route('bank.bulk_action') }}" id="quick-action-form"
                                ...
                                <button id="quick-action-apply" class="btn btn-primary" data-ajax="true"
                                    data--submit="{{ route('bank.bulk_action') }}" data-datatable="reload"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                    "type": "GET",
                    "url": '{{ route('bank.index_data', ['user_id' => $providerdata->id]) }}',
                    "data": function(d) {
                        d.search = {
                            value: $('.dt-search').val()
                        };
