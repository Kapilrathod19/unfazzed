...
Route::get('registration-fields', [API\CommanController::class, 'getRegistrationFields']);
...
Route::post('check-field', [API\User\UserController::class, 'checkUsername']);
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::post('address-save', [App\Http\Controllers\AddressController::class, 'storeOrUpdate']);
