...
class AlterNotificationTemplatesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            // 'whatsapp_template_detail' => '<p>Payout of [[ pay_amount ]] has been processed.</p>',
            // 'sms_template_detail' => '<p>Payout of [[ pay_amount ]] has been processed.</p>',
            // 'mail_template_detail' => '<p>Payout of [[ pay_amount ]] has been processed.</p>',
        ]);
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            // 'sms_subject' => 'New Subscription Plan Activated',
            // 'mail_subject' => 'New Subscription Plan Activated',
            // 'template_detail' => '<p>New plan subscribed - [[ plan_name ]].</p>',
            // 'mail_template_detail' => '<p>New plan subscribed - [[ plan_name ]].</p>',
            // 'whatsapp_template_detail' => '<p>New plan subscribed - [[ plan_name ]].</p>',
            // 'sms_template_detail' => '<p>New plan subscribed - [[ plan_name ]].</p>',
        ]);
        // create
        $template = NotificationTemplate::create([
